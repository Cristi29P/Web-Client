...
char *compute_post_request(char *host, char *url, char* content_type, char **body_data,
    ...
    */
    ...
    sprintf(line, "Content-Length: %d", len + body_data_fields_count - 1);
    compute_message(message, line);
...
char *compute_post_request_token(char *host, char *url, char* content_type, char **body_data,
